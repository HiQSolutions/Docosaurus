...
La funzione **Fornitori Due Diligence** supporta il processo di valutazione strutturata dei fornitori ICT attraverso l'analisi di indicatori finanziari, ESG, reputazionali e di conformita'.
La funzionalita' consente di raccogliere, consultare e calcolare uno scoring complessivo del fornitore, utile per le attivita' di Vendor Risk Management, per la classificazione del rischio e per il supporto alle decisioni di sourcing e outsourcing ICT.

La funzione e' utilizzata in conformita' alle normative di riferimento (es. DORA, linee guida EBA e disposizioni Banca d'Italia) e contribuisce a garantire un presidio continuo del rischio di terze parti.
...
- CERT: certificazioni e requisiti di conformita'
...
- Il punteggio Totale e' calcolato aggregando i valori delle singole dimensioni (Financial, ESG, Reputational, CERT)
- La Classe di Rischio e' determinata sulla base di soglie configurabili associate al punteggio totale
